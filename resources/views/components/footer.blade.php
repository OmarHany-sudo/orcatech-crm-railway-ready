    ...
    <div class="mx-auto max-w-(--breakpoint-xl)">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <span class="text-xs text-gray-600">{{ config('app.company_address', '') }}</span> <br>
                    <span class="text-xs text-gray-600">UK Non-geographic: {{ config('app.company_phone', '') }}</span>  <br>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400" title="{{config('app.version')}}">
                {{ '© '.date('Y').' '.config('app.name', 'OrcaTech CRM') }}
            </span>
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="{{ config('services.github.url', '#') }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
                ...
                <a href="{{ config('services.youtube.url', '#') }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
